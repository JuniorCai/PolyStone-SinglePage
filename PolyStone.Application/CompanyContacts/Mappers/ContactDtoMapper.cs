...
namespace PolyStone.CompanyContacts.Mappers
{
    /// <summary>
    /// ContactDto映射配置
    /// </summary>
    public class ContactDtoMapper
    {
        ...
        /// <summary>
        ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(ContactDtoMapper.CreateMappings);
        ///注入位置    < see cref = "PolyStoneApplicationModule" /> 
        ...
        private static void CreateMappingsInternal(IMapperConfigurationExpression configuration)
        {
            ...
            //    Mapper.CreateMap<Contact,ContactEditDto>();
            //     Mapper.CreateMap<Contact, ContactListDto>();

            //       Mapper.CreateMap<ContactEditDto, Contact>();
