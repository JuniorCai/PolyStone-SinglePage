...
namespace PolyStone.Modules.Mappers
{
    /// <summary>
    /// ModuleDto映射配置
    /// </summary>
    public class ModuleDtoMapper
    {
        ...
        /// <summary>
        ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(ModuleDtoMapper.CreateMappings);
        ...
        private static void CreateMappingsInternal(IMapperConfigurationExpression configuration)
        {
            ...
            //    Mapper.CreateMap<Module,ModuleEditDto>();
            //     Mapper.CreateMap<Module, ModuleListDto>();

            //       Mapper.CreateMap<ModuleEditDto, Module>();
            //        Mapper.CreateMap<ModuleListDto,Module>();
